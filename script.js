class Calculator {
  ...
  getDisplayNumber(number) {
    if (number === 'Error') return 'Error'; // Special case for division by zero
  ...
  updateDisplay() {
    ...
    if (this.operation != null) {
      this.previousNum.innerText = `${this.getDisplayNumber(
        this.previousOperand
      )} ${this.operation}`;
    } else {
...
const previousNum = document.querySelector('[data-prev-operand]');
